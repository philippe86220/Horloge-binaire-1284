...
👉 Le Schéma est valable aussi bien pour un 1284 ou 1284P :
...
- Ajouter un réglage manuel de l’heure   
  (le module RTC est très performant donc ce n'est pas indispensable de plus il est amovible et réglable via l'ide Arduino)
